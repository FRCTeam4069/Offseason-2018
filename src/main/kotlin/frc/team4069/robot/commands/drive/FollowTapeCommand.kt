...
class FollowTapeCommand(val baseVelocity: VelocityUnit = 3.fps, val correctionFactor: Double = 0.5) : Command() {
    ...
    override fun execute() {
        val speedDelta = (baseVelocity.fps * VisionSystem.tapeX.toDouble() * correctionFactor) / VisionSystem.width.toDouble()
